...
CREATE TABLE public.notification_asset_importance (
...
CREATE TABLE public.gateway_hiding (
    ...
    CONSTRAINT gateway_hiding_pk PRIMARY KEY (user_id, gateway_id),
...
CREATE TABLE public.device_hiding (
    ...
    device_id bigint NOT NULL,
    hidden boolean NOT NULL,
    CONSTRAINT device_hiding_pk PRIMARY KEY (user_id, device_id),
    CONSTRAINT user_id_fk FOREIGN KEY (user_id) REFERENCES public.iot_user(id),
